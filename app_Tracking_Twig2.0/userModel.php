...
class userModel {
  ...
  public function add_user($nombre,$correo){
        ...
        if (!$existe) {
              ...
              $userCorreo = new userCorreo();
              $userCorreo->enviarCorreoBienvenida($nombre,$correo);
          }
    }
    
    public function add_position($nombre,$correo,$longitud,$latitud,$tiempo){
	     include 'conexion.php';
       ...
       $userCorreo = new userCorreo();
       $userCorreo->enviarCorreoPosiciones($nombre,$correo);
    }
}
